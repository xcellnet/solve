           ...
           <div class="row">
            ...
            <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-offset-3 col-lg-6">
                                    <h3>Benjamin Campbell</h3>
                                        <hr>
                                </div>
                                <div class="col-lg-offset-3 col-lg-2">
                                <img src="/solve/img/profile/10460178_10206174571139177_4940363198446242053_n.jpg" class="img-circle" height="160" width="160"><hr>
                                    <strong>Skills</strong>
<div class="skill"> <span class="label label-primary">#hardware</span> <span class="label label-primary">#software</span> <span class="label label-primary">#PHP</span> <span class="label label-primary">#Javascript</span> 
</div>
                                </div>
                                <div class="col-lg-4">
