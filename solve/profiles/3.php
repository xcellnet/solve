        ...
        <div id="page-wrapper">
           ...
           <div class="row">
            ...
            <!-- /.col-lg-6 (nested) -->
                                ...
                                <img src="/solve/img/profile/1157638_10203399684978672_1162716716_n.jpg" class="img-circle" height="160" width="160"><hr>
                                   <strong>Skills</strong>
<div class="skill"> <span class="label label-primary">#plumbing</span> <span class="label label-primary">#electical</span> <span class="label label-primary">#Car Repair</span> <span class="label label-primary">#Life Coach</span>
</div></div>
                                <div class="col-lg-4">
