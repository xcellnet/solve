           ...
           <div class="row">
            ...
            <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-offset-3 col-lg-6">
                                    <h3>Gabrielle Peake</h3>
                                        <hr>
                                </div>
                                <div class="col-lg-offset-3 col-lg-2">
                                <img src="/solve/img/profile/11698596_10206651778554619_8875289555553885898_n.jpg" class="img-circle" height="160" width="160"><hr>
                                   <strong>Skills</strong>
<div class="skill"> <span class="label label-primary">#life coach</span> <span class="label label-primary">#goal setting</span> <span class="label label-primary">#cooking</span> <span class="label label-primary">#vocal coach</span>
</div>
                                </div>
                                <div class="col-lg-4">
