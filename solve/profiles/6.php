           ...
           <div class="row">
            ...
            <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-offset-3 col-lg-6">
                                    <h3>Elizabeth McDonald</h3>
                                        <hr>
                                </div>
                                <div class="col-lg-offset-3 col-lg-2">
                                <img src="/solve/img/profile/11178300_10204740852374910_429041292436772476_n" class="img-circle" height="160" width="160"><hr>
                                  <strong>Skills</strong>
<div class="skill"> <span class="label label-primary">#hardware</span> <span class="label label-primary">#software</span> <span class="label label-primary">#PHP</span> <span class="label label-primary">#Javascript</span> <span class="label label-primary">#Javascript</span> <span class="label label-primary">#node.js</span>
</div>
                                </div>
                                <div class="col-lg-4">
